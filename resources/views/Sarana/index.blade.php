        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl text-center">Daftar Sarana
                    </h1>
                    <div class="mt-1 mb-4">
                        <a class="px-2 py-2 text-sm text-white bg-blue-600 rounded"
                            href="{{ route('sarana.create') }}">{{ __('Add Sarana dan Prasarana') }}</a>
                    </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400  display nowrap" id="example">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('sarana.edit',$srn->id) }}">
                                    ...
                                    <td class="px-6 py-4">
                                     ...
                                     <td class="px-6 py-4">
                                        <a href="{{ route('sarana.destroy', $srn->id) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">
