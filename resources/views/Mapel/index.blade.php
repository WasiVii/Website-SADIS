        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl text-center">Daftar Mata Pelajaran
                    </h1>
                    <div class="mt-1 mb-4">
                    ...
                    <div class="mt-1 mb-4">
                        <a class="px-2 py-2 text-sm text-white bg-red-600 rounded"
                            href="{{ url('dashboard/dashboard/mapel/generatePDF') }}">{{ __('Export PDF') }}</a>
                        <a class="px-2 py-2 text-sm text-white bg-green-600 rounded"
                            href="{{ url('dashboard/dashboard/mapel/exportExcel') }}">{{ __('Export Excel') }}</a>
                        ...
                        <div class="overflow-hidden">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a class="px-2 py-2 text-sm text-white bg-red-600 rounded"
                                            href="{{ route('mapel.generatePDFid', $mpl->id) }}">{{ __('PDF') }}</a>
                                    </td>
                                </tr>
                                @php
                                    $no++
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ url('dashboard/dashboard/mapel/importExcel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
