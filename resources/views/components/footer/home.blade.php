<footer>
    @if(Request::path() == '/')
    <section class="py-10 bg-main-color sm:pt-16 lg:pt-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                    <p class="normal-case text-4xl font-bold">SADISschool</p>

                    <p class="text-base leading-relaxed text-gray-600 mt-7">SADIS School adalah sekolah menengah atas yang berbasis Teknologi Informasi dan berwawasan lingkungan, mantap dalam IMTAQ, unggul dalam IPTEK, berprestasi dalam olahraga dan seni serta siap bersaing dalam menghadapi era global.</p>
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-4">
                        <li>
                            <a href="/profile/sekolah" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About </a>
                        </li>

                        <li>
                            <a href="/teams" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Our Teams </a>
                        </li>

                        <li>
                            <a href="/profile/data-guru" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Staff </a>
                        </li>
    ...
    @endif
    <section class="pb-10 bg-main-color">
        <x-footer.copyright/>
    </section>
