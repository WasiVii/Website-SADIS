                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-1 mb-4">
                        <a class="px-2 py-2 text-sm text-white bg-red-600 rounded"
                            href="{{ url('dashboard/dashboard/kelas/generatePDF') }}">{{ __('Export PDF') }}</a>
                        <a class="px-2 py-2 text-sm text-white bg-green-600 rounded"
                            href="{{ url('dashboard/dashboard/kelas/exportExcel') }}">{{ __('Export Excel') }}</a>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400  display nowrap" id="example">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('kelas.destroy', $kls->id) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ url('dashboard/dashboard/kelas/importExcel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
